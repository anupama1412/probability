...
\hhline{|-|-}
	...
	{\gnumericPB{\raggedright}\gnumbox[l]{Bernoulli Random Variable (Item is not defective)}}
\\
\hhline{|--|}
	 \multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$X=1$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Bernoulli Random Variable (Item is defective)}}
\\
\hhline{|-|-|}
\multicolumn{1}{|p{\gnumericColA}|}%
...
\multicolumn{1}{|p{\gnumericColA}|}%
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Probability of single successful outcome}}
\\
\hhline{|-|-|}
\multicolumn{1}{|p{\gnumericColA}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$k$}}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Number of successful outcomes}}
\\
\hhline{|-|-|}
\end{tabular}
