...
\item Define the Gamma cdf function using 2 parameters, x, input value, and n shape parameter.
\item In the main function, variables are declared and initialized.
\item Inside the loop, 'gammaCDF' function is called with current 'x' value, scaled by 'n', to calculate corresponding gamma CDF.
