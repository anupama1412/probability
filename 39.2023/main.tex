...
By definition,
The median of a distribution is the value such that half of the probability mass of the distribution is below that value.\\
Thus, for a function $f(x; \mu)$,
\begin{align}
...
$F(X_1) = 1 - e^{-n(x - \mu)}$
\begin{align}
\implies P(\hat{M} \leq y) &= F(y - \log_e 2)\\
&= 1 - e^{-n(y - \log_e 2 - \mu)}
\end{align}
When $y = 2$ and $\mu = 1$,
\begin{align}
